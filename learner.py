...
from models.TComplEx import TComplEx
from models.TPComplEx import TPComplEx
from models.LowFERT import LowFERT
from models.LowFERTNT import LowFERTNT

from utils.regularizers import N3, Lambda3

parser = argparse.ArgumentParser(description="Temporal ComplEx")
parser.add_argument("--dataset", default="ICEWS14", type=str, help="Dataset name")
models = ["ComplEx", "TComplEx", "TPComplEx", "LowFERT", " LowFERTNT"]
parser.add_argument(
    "--model", default="TPComplEx", choices=models, help="Model in {}".format(models)
)
...
model = {
    ...
    "LowFERT": LowFERT(
        ...
        drop_rates=(args.input_dropout, args.hidden_dropout1, args.hidden_dropout2),
        k=args.k,
    ),
    "LowFERTNT": LowFERTNT(
        sizes,
